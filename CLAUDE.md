# CLAUDE.md - Roofing123

## Business Context

**Business Name:** Roofing123
**ABN:** 13 433 610 342
**Phone:** 0420 907 147
**Location:** Sydney, New South Wales
**Hours:** Monday to Saturday, 7am - 5pm
**Owner:** Mouhmad

### About
- Sydney-based roofing and gutter care business covering all Sydney suburbs
- Sydney is the primary service area - use this for local SEO targeting (e.g. "roofing Sydney", "gutter cleaning Sydney", "roof repair Sydney NSW")
- Covers essential roofing services - gutter cleaning, roof maintenance, and roof repair
- Site originally built on Webflow - rebuilding as a custom site
- Quote request form with fields for name, email, phone, suburb, and service type
- Contactable via phone

### Services

**Gutter Cleaning**
- Full gutter clean-outs
- Downpipe clearing
- Debris removal
...
- Git remote: `origin` -> `https://github.com/suterasites/roofing123.git`
